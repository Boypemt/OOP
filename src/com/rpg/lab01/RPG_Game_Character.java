...
public class RPG_Game_Character {
...
// ==================== CREATE CONSUMABLE ITEMS ====================
        ...
        HealthPotion potionGreater = new HealthPotion("Greater Health Potion",
                100, 3);
        HealthPotion potionMinor = new HealthPotion("Minor Health Potion", 10,
                10);
...
// Demonstrate polymorphism with mixed destructibles
        ...
        List<Destructible> allDestructible = new ArrayList<>();
        allDestructible.add(eastWall); // StoneWall
        allDestructible.add(crate); // WoodenBox
        allDestructible.add(archer); // Character
        System.out.println("--- Mage attacking various targets from polymorphic list ---");
        for (Destructible target : allDestructible) {
